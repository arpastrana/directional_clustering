...
def directional_clustering(vectorfield_tag = "m_1", 
                            align_vectors = True, alignment_ref = [1.0, 0.0, 0.0],
                            smooth_iters = 10, damping = 0.5,
                            clustering_name = "variational kmeans", n_clusters = 5, tol = 1e-6, iters = 30,
                            export_json = False,
                            draw_faces = True, draw_vector_fields = False):
    # ==============================================================================
    # Arguments

    # vector field
    # vectorfield_tag: the vector field to base the clustering on

    # alignment
    # align_vectors: the boolean value showing whether to align vectors
    # alignment_ref: reference vector for alignment

    # smoothing
    # smooth_iters: how many iterations to run the smoothing for
    # damping: damping coefficient, a value from 0 to 1

    # clustering
    # clustering_name: algorithm name
    # n_clusters: clustering_namenumber of clusters to produce
    # tol: loss function threshold for early stopping
    # iters: number of epochs to run kmeans clustering for

    # exporting
    # export_json: the boolean value showing whether to export mesh to JSON file
